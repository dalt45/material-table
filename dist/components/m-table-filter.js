...
function (_React$Component) {
  (0, _inherits2["default"])(MTableFilter, _React$Component);

  function MTableFilter() {
    (0, _classCallCheck2["default"])(this, MTableFilter);
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MTableFilter).apply(this, arguments));
  }

  (0, _createClass2["default"])(MTableFilter, [{
    key: "renderEmpty",
    value: function renderEmpty(emptyRowCount, renderData) {
      var _this = this;

      var localization = (0, _objectSpread2["default"])({}, MTableFilter.defaultProps.localization, this.props.localization);
      ...
      return renderData.map(function (data, index) {
        if (data.tableData.editing) {
          return React.createElement(_this2.props.components.EditRow, {
            ...
            localization: (0, _objectSpread2["default"])({}, MTableFilter.defaultProps.localization.editRow, _this2.props.localization.editRow),
            key: index,
    ...
    value: function render() {
      ...
      return React.createElement("div", {
      ...
      }, this.props.options.filtering && React.createElement(this.props.components.FilterRow, {
        ...
        localization: (0, _objectSpread2["default"])({}, MTableFilter.defaultProps.localization.filterRow, this.props.localization.filterRow),
